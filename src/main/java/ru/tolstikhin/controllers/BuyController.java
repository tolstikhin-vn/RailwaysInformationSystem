...
public class BuyController {
    ...
    void buyTicket(MouseEvent event) {
        ...
        ticketDAO.insertTicket(MainController.getUserId(), trainDAO.selectTrainName(schedule.getScheduleId()),
                SeatSelectionController.getNumberOfWagon(), wagonTypeDAO.selectWagonType(wagonDAO.selectWagon(SeatSelectionController.getNumberOfWagon(),
        ...
        seatDAO.updateSeatBooked(seatDAO.selectSeat(SeatSelectionController.getSeatIndex(), SeatSelectionController.getNumberOfWagon()).getSeatNumber());
